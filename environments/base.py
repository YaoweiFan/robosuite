...
class MujocoEnv(metaclass=EnvMeta):
    ...
    def step(self, action):
        ...
        for i in range(int(2 * self.control_timestep / self.model_timestep)):
            ...
            self.sim.step()
            policy_step = False
            # lepx.append(self.robots[0].controller.ee_pos[0])
            # lepy.append(self.robots[0].controller.ee_pos[1])
            # lepz.append(self.robots[0].controller.ee_pos[2])
            # repx.append(self.robots[1].controller.ee_pos[0])
            # repy.append(self.robots[1].controller.ee_pos[1])
            # repz.append(self.robots[1].controller.ee_pos[2])

        # dataframe = pd.DataFrame({'left_ee_pos_x': lepx, 
        #                             'left_ee_pos_y': lepy,
        #                             'left_ee_pos_z': lepz, 
        #                             'right_ee_pos_x': repx,
        #                             'right_ee_pos_y': repy,
        #                             'right_ee_pos_z': repz,
        #                             })
        # dataframe.to_csv("/home/fyw/Documents/projects/dual-arm-mimic/data/eefpos1.csv")
